...
package com.iftw.materialnavigation.wizard.ui;
...
import com.iftw.materialnavigation.R;
import com.iftw.materialnavigation.service.InterfaceMapping;
import com.iftw.materialnavigation.wizard.model.AbstractWizardModel;
import com.iftw.materialnavigation.wizard.model.ModelCallbacks;
import com.iftw.materialnavigation.wizard.model.Page;
import com.iftw.materialnavigation.wizard.model.ReviewItem;
...
//        mWizardModel = mCallbacks.onGetModel();
        mWizardModel = InterfaceMapping.getInstance().getFragment().onGetModel();
...
//        mCallbacks.onEditScreenAfterReview(mCurrentReviewItems.get(position).getPageKey());
        InterfaceMapping.getInstance().getFragment().onEditScreenAfterReview(mCurrentReviewItems.get(position).getPageKey());
    }
